...
export interface AtlasState { view: Explore; yi: number; flow: Flow; relative: boolean; cum: boolean; county: string | null; lang: Lang }
...
export const colors = (max: number, light = false) => scaleLinear<string>().domain([-max, 0, max])
