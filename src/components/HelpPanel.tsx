  ...
  return (
    ...
    <div className="helpcard" id="helpCard" role="dialog" aria-modal={narrow ? 'true' : 'false'}
      ...
      <div className="help-p">
        ...
        {L(' — izračun, ne mjerenje. Međužupanijski tokovi izmjereni su samo za 2018.; sve ostale godine su procjena (IPF = iterativno usklađivanje margina: struktura iz 2018. skalirana na DZS godišnje zbrojeve). Usklađuju se odseljeni: zbroj svakog retka točno odgovara objavljenim odseljenima u svakoj godini. Usklađivanje je multiplikativno, pa koridor koji je 2018. izmjeren kao nula ostaje nula u svakoj procijenjenoj godini. Doseljeni se reproduciraju samo približno — točno za 2018., unutar nekoliko osoba od 2007., a za 1998.–2006. objavljeni doseljeni se prije usklađivanja skaliraju na ukupne odseljene (nacionalna razlika je tada 27–550 osoba, a 464–550 za 2002.–2006.). Kumulativni zbroj je uvijek procjena.',
          ' — a computation, not a measurement. Inter-county flows are measured for 2018 only; every other year is an estimate (IPF = iterative proportional fitting: the 2018 structure scaled to CBS annual totals). It is the out-margin that is fitted: each row sums exactly to the published out-migration for that year. The fit is multiplicative, so a corridor measured at zero in 2018 stays zero in every estimated year. The in-margin is only reproduced approximately — exactly for 2018, within a few people from 2007, and for 1998–2006 the published in-margin is rescaled to the out-total before fitting (the national gap there runs from 27 to 550 people, 464–550 for 2002–06). A cumulative sum is always an estimate.')}
      </div>
